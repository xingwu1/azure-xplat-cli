...
exports.init = function(cli) {
  ...
  */
  function createPool(jsonFile, options, _) {
    ...
    // TODO: In here, parsing new features: package manangement, etc.
    
    var client = batchUtil.createBatchServiceClient(options);

    var addPool = null;
    if (parsedJson !== null && parsedJson !== undefined) {
      // Handle any special post-processing steps. This is handled here so that any
      // alterations to the JSON will go through the PoolAddParameter deserialization.
      // - Resource Files
      // - etc
