...
batchTemplateUtils.expandTemplate = function (templateFile, parameterFile) {
    ...
    if (templateFile) {
      ...
      mergedJobTemplate = batchTemplateUtils.parseTemplate(templateJsonStr, templateJsonObj, parameterJsonObj);
    }
