...
batchJob.deployPool = function (poolId, properties, startCmd, options, logger, _) {
    ...
    pool.cloudServiceConfiguration = properties.cloudServiceConfiguration;
    ...
    logger.info(JSON.stringify(pool));
