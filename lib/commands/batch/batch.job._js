...
exports.init = function (cli) {
  ...
  */
  ...
  function _expandTemplate(templateFile, parameterFile) {
    ...
    if (templateFile) {
      ...
      mergedJobTemplate = templateUtils.parseTemplate(templateJsonStr, templateJsonObj, parameterJsonObj, logger);
    }
