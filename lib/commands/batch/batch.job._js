  ...
  */
  function createJob(jsonFile, options, _) {
    ...
    if (options.template) {
      ...
      var expandedJobObject = _expandTemplate(options.template, options.parameters, _);
