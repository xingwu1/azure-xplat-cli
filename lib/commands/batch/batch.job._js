...
// TODO: This needs to get moved to a utils file
  function _parseTemplates(templateFile, parameterFile, _) {
    if (templateFile) {
      ...
      if (!parameterFile) {
        ...
        var mergedJobTemplate = jobUtils.parseTemplate(templateJsonStr, templateJsonObj, parameterJsonObj, logger, _);
      }
    }
  }
  ...
  */
  function createJob(jsonFile, templateFile, parameterFile, options, _) {
    ...
    if (templateFile) {
      var mergedJobTemplate = _parseTemplates(templateFile, parameterFile, _);
      ...
      // if (parsedTemplate.job.properties.taskFactories) {
      //   console.log("Handle task factory");
      //   // TODO
      // }
      ...
      // finally, bulid up the jsonFile object to hand to the batch service.
