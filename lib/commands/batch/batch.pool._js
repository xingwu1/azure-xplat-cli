...
exports.init = function(cli) {
  ...
  */
  function createPool(jsonFile, options, _) {
    ...
    if (!__.isUndefined(parsedJson) && !__.isUndefined(parsedJson.clientExtensions) && !__.isUndefined(parsedJson.clientExtensions.dockerOptions)) {
    ...
    // - Resource Files
    // - etc
    addPool = templateUtils.postProcessing(addPool, _);
